  ...
  tools: {
    ...
    "bmi-calculator-hub": {
      ...
      standard: {
        ...
        page_description: "Рассчитайте свой Индекс Массы Тела, используя стандартную формулу ВОЗ. Получите мгновенные результаты с категорией здоровья и персонализированными рекомендациями.",
      },
      adjusted: {
